...
public class ThumbnailatorUtils {
     ...
     * @param outFile
     */
    public static void scaleQuality(File inFile,File outFile) throws IOException {
    ...
    public void test() throws IOException {
      File file = new File("I://123.png");
        Thumbnails.of(file)
                .scale(1f)
                .outputQuality(0.1f)
                .outputFormat("jpg")
                .toFile("i:\\IMG_20131229_114806");
    }
}
